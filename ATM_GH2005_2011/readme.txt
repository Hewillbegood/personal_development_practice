...
Last compilation was done in Visual Studio Community 2015 with update 3.
The language is C++/CLI who works on .NET Framework. The UI API is Windows Forms. SQL Server is also required.
